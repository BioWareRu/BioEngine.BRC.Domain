...
namespace BioEngine.BRC.Domain.Migrations
{
    ...
    [Migration("20181226115010_RedoStorage")]
    partial class RedoStorage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BioEngine.Core.Entities.Section", b =>
                {
                    b.HasOne("BioEngine.Core.Entities.StorageItem", "Logo")
                        .WithMany()
                        .HasForeignKey("LogoId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BioEngine.Core.Entities.StorageItem", "LogoSmall")
                        .WithMany()
                        .HasForeignKey("LogoSmallId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
