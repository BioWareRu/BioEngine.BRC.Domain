...
namespace BioEngine.BRC.Common
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void RegisterContentBlock<TBlock, TBlockData>(this ModelBuilder modelBuilder)
        ...
        public static void RegisterContentItem<TContentItem>(this ModelBuilder modelBuilder)
